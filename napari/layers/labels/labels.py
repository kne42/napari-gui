...
from .mouse_bindings import fill, paint, pick_label
...
class Labels(Image):
    ...
    def mode(self, mode: Union[str, Mode]):
        ...
        if self._mode == Mode.PICKER:
            self.mouse_drag_callbacks.remove(pick_label)
        ...
        if mode == Mode.PAN_ZOOM:
            ...
            self.mouse_drag_callbacks.append(pick_label)
